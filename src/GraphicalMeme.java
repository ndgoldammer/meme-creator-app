...
public class GraphicalMeme extends Meme {
    ...
    public BufferedImage compileMeme(int maxDimension) throws IOException {
        ...
        // Split the caption text into words and create lines that are no wider than the image.
        ...
        // Draw the caption onto the image at the appropriate space based on the alignment option
